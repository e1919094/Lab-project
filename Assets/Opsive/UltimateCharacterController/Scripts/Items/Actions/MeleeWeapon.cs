...
namespace Opsive.UltimateCharacterController.Items.Actions
{
    ...
    public class MeleeWeapon : UsableItem
    {
        ...
        public override void UseItemUpdate()
        {
            ...
            // No need to update if the weapon it is no longer attachking, has already hit an object and it can only hit a single object, or a solid object (such as a shield) was hit.
